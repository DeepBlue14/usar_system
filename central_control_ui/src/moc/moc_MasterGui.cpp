...
QT_MOC_LITERAL(1, 10, 9), // "moveStuff"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "index"
QT_MOC_LITERAL(4, 27, 20) // "operatorWasTriggered"

    },
    "MasterGui\0moveStuff\0\0index\0"
    "operatorWasTriggered"
};
...
void MasterGui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->moveStuff((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->operatorWasTriggered(); break;
        default: ;
        }
    }
}
