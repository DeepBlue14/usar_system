#include "../include/robot_operator_ui/InRunGui.h"
...
InRunGui::InRunGui(QWidget* parent) : QWidget(parent)
{
    ...
    langsStrLstPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/compass.png"), "Map") );
    langsStrLstPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/robot.png"), "Robot") );
    langsStrLstPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/target.png"), "Gun") );
    langsStrLstPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/voice.png"), "Voice") );
    langsStrLstPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/autonomy.png"), "Autonomy") );
    
    
    
    cFileOptLstWidPtrVecPtr = new QVector<QListWidgetItem*>();
    cFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/selected.png"),
    ...
    cppFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/selected.png"),
                                                             "RGB") );
    cppFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/not_selected.png"),
                                                             "IR") );
    
    pythonFileOptLstWidPtrVecPtr = new QVector<QListWidgetItem*>();
    pythonFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/not_selected.png"),
                                                             "RGB") );
    pythonFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/selected.png"),
                                                             "TARGET") );
    
    javaFileOptLstWidPtrVecPtr = new QVector<QListWidgetItem*>();
    javaFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/not_selected.png"),
                                                             "Duplex") );
    javaFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/selected.png"),
                                                             "Off") );
    javaFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/not_selected.png"),
                                                             "Input only") );
    javaFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/not_selected.png"),
    ...
    lispFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/selected.png"),
                                                             "Full teleop") );
    lispFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/not_selected.png"),
                                                             "Auto drive") );
    lispFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/not_selected.png"),
                                                             "Auto shoot") );
    lispFileOptLstWidPtrVecPtr->push_back(new QListWidgetItem(QIcon("src/usar_teleop/robot_operator_ui/res/not_selected.png"),
